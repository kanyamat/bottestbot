...
############################################## Conversation ##############################################
 ...
 //    ];
  ...
  }else if (strpos($_msg, 'แพ้ท้อง') !== false || strpos($_msg, 'ตั้งครรภ์') !== false || strpos($_msg, 'คนท้อง') !== false || strpos($_msg, 'ปวดท้อง') !== false || strpos($_msg, 'ท้องแข็ง') !== false || strpos($_msg, 'กิน') !== false || strpos($_msg, 'ทาน') !== false || strpos($_msg, 'ดื่ม') !== false || strpos($_msg, 'ฝากครรภ์') !== false || strpos($_msg, 'หมอ') !== false || strpos($_msg, 'pk') !== false || strpos($_msg, 'สมุนไพร') !== false  )  {
    $replyToken = $event['replyToken'];
