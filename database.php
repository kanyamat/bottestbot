...
(2, '0002', 'ดิฉันสามารถให้ข้อมูลที่เกี่ยวข้องกับการตั้งครรภ์ในระยะต่างๆ และหากคุณให้ข้อมูลน้ำหนักในแต่ละสัปดาห์ ดิฉันสามารถแสดงผลกราฟน้ำหนักตลอดช่วงการตั้งครรภ์เพื่อการเฝ้าระวังภาวะเบาหวานได้นะคะ', NULL, 1, '0003', NULL, NULL),
...
(5, '0005', '<มี link ไปอ่าน agreement> Note: Agreement เดี๋ยวไปก๊อปเอา ประมาณว่าข้อมูลที่ให้โดย REMI ทางเราไม่รับผิดชอบ ห้ามฟ้องร้องทีหลัง<มีปุ่มยืนยัน และยกเลิก>', NULL, 3, '0006', NULL, NULL),

(6, '0006', 'ก่อนอื่น ดิฉันขออนุญาตถามข้อมูลเบื้องต้นเกี่ยวกับคุณก่อนนะคะขอทราบปีพ.ศ.เกิดเพื่อคำนวณอายุค่ะ', NULL, 2, '0007', NULL, NULL),

(7, '0007', 'คุณอายุ ', 'ปี ถูกต้องหรือไม่ค่ะ ถ้าไม่ถูกต้องกรุณาพิมพ์ตัวเลขใหม่', 3, '0008', NULL, NULL),

(8, '0008', 'ขอทราบครั้งสุดท้ายที่คุณมีประจำเดือนเพื่อคำนวณอายุครรภ์ค่ะ (กรุณาตอบประมาณวันที่และเดือนเป็นตัวเลขนะคะ เช่น 17 04 คือ วันที่ 17 เมษายน)', NULL, 2, '0009', NULL, NULL),

(9, '0009', 'คุณมีอายุครรภ์ ', 'ถูกต้องหรือไม่ค่ะ ถ้าไม่ถูกต้องกรุณาพิมพ์ตัวเลขใหม่', 3, '0010', NULL, NULL),

(12, '0010', 'ขออนุญาตถามน้ำหนักปกติก่อนตั้งครรภ์ของคุณค่ะ (กรุณาตอบเป็นตัวเลขในหน่วยกิโลกรัม)', NULL, 2, '0011', NULL, NULL),

(13, '0011', 'ก่อนตั้งครรภ์ คุณมีน้ำหนัก ', 'กิโลกรัม ถูกต้องหรือไม่ค่ะ ถ้าไม่ถูกต้องกรุณาพิมพ์ตัวเลขใหม่  ', 3, '0012', NULL, NULL),

(14, '0012', 'ขออนุญาตถามน้ำหนักปัจจุบันของคุณค่ะ (กรุณาตอบเป็นตัวเลขในหน่วยกิโลกรัม)', NULL, 2, '0013', NULL, NULL),
...
(24, '0017', 'สัปดาห์นี้คุณแม่มีน้ำหนักเท่าไหร่แล้วคะ', NULL, NULL, NULL, NULL, NULL)";
pg_exec($dbconn, $sql1) or die(pg_errormessage());
